...
function checkout_pdp(){
	...
	echo '<br><a rel="no-follow" class="single_add_to_cart_button-12 button alt" id="kupay_pdp_checkout" style="display: inline-block; margin-top: 12px;" onclick="kupayCheckout();"> Buy in 1-Click with KuPay </a>';
...
//
//	if(!empty($order) && !empty($order->id) && !empty($order->order_key)){
//
//		$href = redirect_to_place_order_page_url($order->id, $order->order_key);
